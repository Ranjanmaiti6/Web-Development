...
Form.addEventListener(('submit') , (e) => {
    ...
    const day = parseInt(document.getElementById('day').value);   //string to int
    const month = parseInt(document.getElementById('month').value);
    const year = parseInt(document.getElementById('year').value);

    const text = `Hi ${name} ${surname}, Your zordic sign is: ${zodiacSigns[month-1]}. ${compliments[day-1]} ${victimCardCompliments[year%20]} ${recommendations[(day*month)%30]}
